...
{
    derived: crate::yewdux::Dispatch<Derived>,
    _marker: std::marker::PhantomData<Store>,
}

impl<Store, Derived> crate::yewdux::Listener for Listener<Store, Derived>
where
    Store: crate::Store,
    Derived: DerivedFrom<Store>,
{
...
where
    ...
    Derived: DerivedFrom<Store>,
{
    crate::yewdux::init_listener(
        || Listener {
            derived: crate::yewdux::Dispatch::<Derived>::new(cx),
...
impl<Store, Derived> crate::yewdux::Listener for ListenerMut<Store, Derived>
where
    Store: crate::Store,
    Derived: DerivedFromMut<Store>,
{
